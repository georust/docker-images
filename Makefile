...
geo-ci:
	$(DOCKER_BUILD_CMD) -f $(DOCKERFILE_DIR)geo-ci -t georust/geo-ci:$(DOCKER_TAG) .

proj-ci:
	$(DOCKER_BUILD_CMD) -f $(DOCKERFILE_DIR)proj-ci -t georust/proj-ci:$(DOCKER_TAG) .

proj-ci-without-system-proj:
	$(DOCKER_BUILD_CMD) -f $(DOCKERFILE_DIR)proj-ci-without-system-proj -t georust/proj-ci-without-system-proj:$(DOCKER_TAG) .

libproj-builder:
	$(DOCKER_BUILD_CMD) -f $(DOCKERFILE_DIR)libproj-builder -t georust/libproj-builder:$(DOCKER_TAG) .
